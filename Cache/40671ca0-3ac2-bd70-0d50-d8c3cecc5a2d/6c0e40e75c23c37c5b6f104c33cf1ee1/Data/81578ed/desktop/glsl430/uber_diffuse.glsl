...
//spec_const bool sc_CanUseTextureLod 103 0
...
//spec_const bool sc_ProxyAlphaOne 123 0
//spec_const bool sc_RayTracedAoTextureHasSwappedViews 124 0
//spec_const bool sc_RayTracedDiffIndTextureHasSwappedViews 125 0
...
{
l9_501=vec3(l9_452.z)*tempGlobals.VertexColor.xyz;
}
else
{
l9_501=vec3(l9_452.z);
}
vec3 l9_502;
...
#endif
float l9_503=clamp(l9_123,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_503<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_503<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_504=max(l9_122.xyz,vec3(0.0));
vec4 l9_505;
#if (sc_ProjectiveShadowsCaster)
{
l9_505=vec4(l9_504,l9_503);
}
#else
{
l9_505=ngsCalculateLighting(l9_504,l9_503,l9_502,l9_7,l9_8,max(l9_450,vec3(0.0)),0.0,1.0,clamp(l9_501,vec3(0.0),vec3(1.0)),vec3(1.0));
}
#endif
vec4 l9_506=max(l9_505,vec4(0.0));
if (isProxyMode)
{
vec4 l9_507;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0Internal(max(l9_507,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_509;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_511=clamp(l9_506.w*2.0,0.0,1.0);
}
#else
{
float l9_512;
...
{
l9_512=clamp(dot(l9_506.xyz,vec3(l9_506.w)),0.0,1.0);
}
#else
{
float l9_513;
...
#if (sc_BlendMode_Multiply)
{
l9_514=(1.0-dot(l9_506.xyz,vec3(0.33333001)))*l9_506.w;
}
#else
{
float l9_515;
...
{
l9_515=(1.0-clamp(dot(l9_506.xyz,vec3(1.0)),0.0,1.0))*l9_506.w;
}
#else
{
float l9_516;
#if (sc_BlendMode_ColoredGlass)
{
l9_516=clamp(dot(l9_506.xyz,vec3(1.0)),0.0,1.0)*l9_506.w;
}
#else
{
float l9_517;
#if (sc_BlendMode_Add)
{
l9_517=clamp(dot(l9_506.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_518;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_518=clamp(dot(l9_506.xyz,vec3(1.0)),0.0,1.0)*l9_506.w;
}
#else
{
float l9_519;
...
{
l9_519=dot(l9_506.xyz,vec3(0.33333001))*l9_506.w;
}
#else
{
float l9_520;
#if (sc_BlendMode_Min)
{
l9_520=1.0-clamp(dot(l9_506.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_521;
#if (sc_BlendMode_Max)
{
l9_521=clamp(dot(l9_506.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_521=1.0;
...
#endif
l9_509=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_506.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_510);
}
#else
{
vec4 l9_522;
...
{
vec3 l9_524=sc_GetFramebufferColor().xyz;
vec3 l9_525=mix(l9_524,definedBlend(l9_524,l9_506.xyz).xyz,vec3(l9_506.w));
vec4 l9_526=vec4(l9_525.x,l9_525.y,l9_525.z,vec4(0.0).w);
l9_526.w=1.0;
l9_523=l9_526;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_528=l9_506.w;
l9_527=vec4(mix(vec3(1.0),l9_506.xyz,vec3(l9_528)),l9_528);
}
#else
{
vec4 l9_529;
...
{
float l9_530=l9_506.w;
float l9_531;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_531=clamp(l9_530,0.0,1.0);
}
#else
{
l9_531=l9_530;
...
#endif
l9_529=vec4(l9_506.xyz*l9_531,l9_531);
}
#else
{
l9_529=l9_506;
...
{
l9_534=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_534=vec4(0.0);
...
vec4 l9_536=outputMotionVectorsIfNeeded(varPos,max(l9_535,vec4(0.0)));
vec4 l9_537=clamp(l9_536,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_538=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_538-0.0039215689)),min(1.0,l9_538+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_540=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_539).xy);
float l9_541=packValue(l9_540);
int l9_548=int(l9_537.w*255.0);
float l9_549=packValue(l9_548);
sc_writeFragData0Internal(vec4(packValue(l9_540),packValue(l9_540),packValue(l9_540),packValue(l9_540)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_541,packValue(l9_540),packValue(l9_540),packValue(l9_540)));
sc_writeFragData2(vec4(l9_549,packValue(l9_548),packValue(l9_548),packValue(l9_548)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_552=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_552).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_557==0)
{
l9_560=texture(sc_OITAlpha0,l9_552);
l9_559=texture(sc_OITDepthLow0,l9_552);
l9_558=texture(sc_OITDepthHigh0,l9_552);
}
else
{
l9_560=vec4(0.0);
...
if (l9_557==1)
{
l9_563=texture(sc_OITAlpha1,l9_552);
l9_562=texture(sc_OITDepthLow1,l9_552);
l9_561=texture(sc_OITDepthHigh1,l9_552);
}
else
{
l9_563=l9_560;
...
if (any(notEqual(l9_561,vec4(0.0)))||any(notEqual(l9_562,vec4(0.0))))
{
int l9_564[8]=l9_553;
unpackValues(l9_561.w,l9_557,l9_564);
unpackValues(l9_561.z,l9_557,l9_564);
unpackValues(l9_561.y,l9_557,l9_564);
unpackValues(l9_561.x,l9_557,l9_564);
unpackValues(l9_562.w,l9_557,l9_564);
unpackValues(l9_562.z,l9_557,l9_564);
unpackValues(l9_562.y,l9_557,l9_564);
unpackValues(l9_562.x,l9_557,l9_564);
int l9_573[8]=l9_554;
unpackValues(l9_563.w,l9_557,l9_573);
unpackValues(l9_563.z,l9_557,l9_573);
unpackValues(l9_563.y,l9_557,l9_573);
unpackValues(l9_563.x,l9_557,l9_573);
}
l9_557++;
continue;
}
...
vec4 l9_578=texture(sc_OITFilteredDepthBoundsTexture,l9_552);
vec2 l9_579=l9_578.xy;
int l9_580;
#if (sc_SkinBonesCount>0)
{
l9_580=encodeDepth(((1.0-l9_578.x)*1000.0)+getDepthOrderingEpsilon(),l9_579);
}
#else
{
l9_580=0;
...
#endif
int l9_581=encodeDepth(viewSpaceDepth(),l9_579);
vec4 l9_582;
l9_582=l9_537*l9_537.w;
vec4 l9_583;
int l9_584=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_584<8)
{
int l9_585=l9_553[l9_584];
int l9_586=l9_581-l9_580;
bool l9_587=l9_585<l9_586;
bool l9_588;
if (l9_587)
{
l9_588=l9_553[l9_584]>0;
}
else
{
l9_588=l9_587;
...
if (l9_588)
{
vec3 l9_589=l9_582.xyz*(1.0-(float(l9_554[l9_584])/255.0));
l9_583=vec4(l9_589.x,l9_589.y,l9_589.z,l9_582.w);
}
else
{
l9_583=l9_582;
...
sc_writeFragData0Internal(l9_582,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
