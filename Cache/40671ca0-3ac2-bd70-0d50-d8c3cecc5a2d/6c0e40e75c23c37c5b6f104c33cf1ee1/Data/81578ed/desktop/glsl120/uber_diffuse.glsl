...
//spec_const bool SC_DISABLE_FRUSTUM_CULLING 42 0
//spec_const bool SC_GL_FRAGMENT_PRECISION_HIGH 43 0
...
float l9_268=l9_267;
vec3 l9_269=sc_SamplingCoordsViewToGlobal(vec2(l9_264,l9_266),materialParamsTexLayout,l9_247);
vec4 l9_270=texture2D(materialParamsTex,l9_269.xy,0.0);
vec4 l9_271;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
...
{
l9_272=vec3(l9_271.z)*tempGlobals.VertexColor.xyz;
}
else
{
l9_272=vec3(l9_271.z);
}
vec3 l9_273;
...
#endif
float l9_274=clamp(l9_62,0.0,1.0);
...
#endif
vec3 l9_275=max(l9_61.xyz,vec3(0.0));
vec4 l9_276;
#if (sc_ProjectiveShadowsCaster)
{
l9_276=vec4(l9_275,l9_274);
}
#else
{
vec3 l9_277=clamp(l9_272,vec3(0.0),vec3(1.0));
vec3 l9_278=ssSRGB_to_Linear(l9_275);
vec3 l9_279=normalize(l9_273);
vec3 l9_280=ssSRGB_to_Linear(max(l9_245,vec3(0.0)));
vec3 l9_281;
#if (sc_SSAOEnabled)
{
l9_281=evaluateSSAO(varPos);
}
#else
{
l9_281=l9_277;
...
#endif
vec3 l9_282=l9_278*(1.0-0.0);
SurfaceProperties l9_283=SurfaceProperties(l9_282,l9_274,l9_279,varPos,l9_3,0.0,1.0,l9_280,l9_281,vec3(1.0),vec3(1.0),vec3(0.039999999));
vec4 l9_284=vec4(1.0);
vec3 l9_285;
vec3 l9_286;
vec3 l9_287;
vec3 l9_288;
...
l9_293=vec3(0.0);
l9_292=vec3(0.0);
LightingComponents l9_299;
LightProperties l9_300;
SurfaceProperties l9_301;
vec3 l9_302;
int l9_303=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_303<sc_DirectionalLightsCount)
{
LightingComponents l9_304=accumulateLight(LightingComponents(l9_292,l9_293,l9_298,l9_296,l9_295,l9_294),LightProperties(sc_DirectionalLights[l9_303].direction,sc_DirectionalLights[l9_303].color.xyz,sc_DirectionalLights[l9_303].color.w*l9_284[(l9_297<3) ? l9_297 : 3]),l9_283,l9_3);
l9_298=l9_304.indirectDiffuse;
l9_297++;
l9_296=l9_304.indirectSpecular;
l9_295=l9_304.emitted;
l9_294=l9_304.transmitted;
l9_293=l9_304.directSpecular;
l9_292=l9_304.directDiffuse;
l9_303++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_321<sc_PointLightsCount)
{
vec3 l9_323=sc_PointLights[l9_321].position-varPos;
vec3 l9_324=normalize(l9_323);
float l9_325=l9_284[(l9_322<3) ? l9_322 : 3];
float l9_326=clamp((dot(l9_324,sc_PointLights[l9_321].direction)*sc_PointLights[l9_321].angleScale)+sc_PointLights[l9_321].angleOffset,0.0,1.0);
float l9_327=(sc_PointLights[l9_321].color.w*l9_325)*(l9_326*l9_326);
float l9_328;
if (sc_PointLights[l9_321].falloffEnabled)
{
l9_328=l9_327*computeDistanceAttenuation(length(l9_323),sc_PointLights[l9_321].falloffEndDistance);
}
else
{
l9_328=l9_327;
...
l9_314=l9_322+1;
LightingComponents l9_329=accumulateLight(LightingComponents(l9_308,l9_309,l9_313,l9_312,l9_311,l9_310),LightProperties(l9_324,sc_PointLights[l9_321].color.xyz,l9_328),l9_283,l9_3);
l9_315=l9_329.directDiffuse;
l9_316=l9_329.directSpecular;
l9_317=l9_329.indirectDiffuse;
l9_318=l9_329.indirectSpecular;
l9_319=l9_329.emitted;
l9_320=l9_329.transmitted;
l9_313=l9_317;
l9_322=l9_314;
l9_312=l9_318;
l9_311=l9_319;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_332=abs(varShadowTex-vec2(0.5));
vec4 l9_333=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_332.x,l9_332.y),0.5);
l9_331=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_333.xyz,vec3(sc_ShadowColor.w)),vec3(l9_333.w*sc_ShadowDensity));
}
#else
{
l9_331=vec3(1.0);
...
{
float l9_335=-l9_279.z;
float l9_336=l9_279.x;
vec2 l9_337=vec2((((l9_336<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_335/length(vec2(l9_336,l9_335)),-1.0,1.0)))-1.5707964,acos(l9_279.y))/vec2(6.2831855,3.1415927);
float l9_338=l9_337.x+(sc_EnvmapRotation.y/360.0);
vec2 l9_339=vec2(l9_338,1.0-l9_337.y);
l9_339.x=fract((l9_338+floor(l9_338))+1.0);
vec4 l9_340;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_341=calcSeamlessPanoramicUvsForSampling(l9_339,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_341=l9_339;
...
#endif
l9_340=sc_EnvmapSpecularSampleViewIndexBias(l9_341,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_342;
...
{
vec2 l9_343=calcSeamlessPanoramicUvsForSampling(l9_339,sc_EnvmapDiffuseSize.xy,0.0);
int l9_344;
#if (sc_EnvmapDiffuseHasSwappedViews)
{
l9_344=1-sc_GetStereoViewIndex();
}
#else
{
l9_344=sc_GetStereoViewIndex();
}
#endif
l9_342=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_343,sc_EnvmapDiffuseLayout,l9_344).xy,-13.0);
}
#else
{
l9_342=sc_EnvmapSpecularSampleViewIndexBias(l9_339,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_340=l9_342;
}
#endif
l9_334=(l9_340.xyz*(1.0/l9_340.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_345;
...
float l9_348=l9_346.y;
float l9_349=l9_346.z;
l9_345=(((((((sc_Sh[8]*0.42904299)*((l9_347*l9_347)-(l9_348*l9_348)))+((sc_Sh[6]*0.74312502)*(l9_349*l9_349)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_347*l9_348))+(sc_Sh[7]*(l9_347*l9_349)))+(sc_Sh[5]*(l9_348*l9_349)))*0.85808599))+((((sc_Sh[3]*l9_347)+(sc_Sh[1]*l9_348))+(sc_Sh[2]*l9_349))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_345=vec3(0.0);
...
{
l9_351=l9_334+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_352=l9_334;
l9_352.x=l9_334.x+(1e-06*sc_AmbientLights[0].color.x);
l9_351=l9_352;
}
#endif
l9_350=l9_351;
...
{
l9_354=l9_350+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_355=l9_350;
l9_355.x=l9_350.x+(1e-06*sc_AmbientLights[1].color.x);
l9_354=l9_355;
}
#endif
l9_353=l9_354;
...
{
l9_357=l9_353+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_358=l9_353;
l9_358.x=l9_353.x+(1e-06*sc_AmbientLights[2].color.x);
l9_357=l9_358;
}
#endif
l9_356=l9_357;
...
{
vec3 l9_360;
l9_360=sc_LightEstimationData.ambientLight;
vec3 l9_361;
int l9_362=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_362<sc_LightEstimationSGCount)
{
float l9_363=dot(sc_LightEstimationData.sg[l9_362].axis,l9_279);
float l9_364=exp(-sc_LightEstimationData.sg[l9_362].sharpness);
float l9_365=l9_364*l9_364;
float l9_366=1.0/sc_LightEstimationData.sg[l9_362].sharpness;
float l9_367=(1.0+(2.0*l9_365))-l9_366;
float l9_368=sqrt(1.0-l9_367);
float l9_369=0.36000001*l9_363;
float l9_370=(1.0/(4.0*0.36000001))*l9_368;
float l9_371=l9_369+l9_370;
float l9_372;
if (step(abs(l9_369),l9_370)>0.5)
{
l9_372=(l9_371*l9_371)/l9_368;
}
else
{
l9_372=clamp(l9_363,0.0,1.0);
}
l9_361=l9_360+((((sc_LightEstimationData.sg[l9_362].color/vec3(sc_LightEstimationData.sg[l9_362].sharpness))*6.2831855)*((l9_367*l9_372)+(((l9_364-l9_365)*l9_366)-l9_365)))/vec3(3.1415927));
l9_360=l9_361;
l9_362++;
continue;
}
...
l9_376=vec3(0.0);
l9_375=vec3(0.0);
l9_374=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_282,vec3(l9_274));
l9_373=1.0;
}
#else
{
...
#endif
vec3 l9_378=l9_375*l9_281;
vec3 l9_379=l9_376+l9_378;
vec3 l9_380=l9_282*l9_379;
vec3 l9_381=l9_307*vec3(1.0);
vec3 l9_382;
if (l9_377)
{
l9_382=l9_380*srgbToLinear(l9_373);
}
else
{
l9_382=l9_380;
}
vec3 l9_383=l9_382+(vec3(0.0)+l9_381);
vec3 l9_384=(l9_383+l9_280)+l9_374;
float l9_385=l9_384.x;
vec4 l9_386=vec4(l9_385,l9_384.yz,l9_373);
vec4 l9_387;
#if (sc_IsEditor)
{
vec4 l9_388=l9_386;
l9_388.x=l9_385+((l9_281.x*1.0)*9.9999997e-06);
l9_387=l9_388;
}
#else
{
...
{
vec3 l9_390=l9_387.xyz*1.8;
vec3 l9_391=(l9_387.xyz*(l9_390+vec3(1.4)))/((l9_387.xyz*(l9_390+vec3(0.5)))+vec3(1.5));
l9_389=vec4(l9_391.x,l9_391.y,l9_391.z,l9_387.w);
}
#else
{
l9_389=l9_387;
...
#endif
vec3 l9_392=vec3(linearToSrgb(l9_389.x),linearToSrgb(l9_389.y),linearToSrgb(l9_389.z));
l9_276=vec4(l9_392.x,l9_392.y,l9_392.z,l9_389.w);
}
#endif
vec4 l9_393=max(l9_276,vec4(0.0));
vec4 l9_394;
#if (sc_ProjectiveShadowsCaster)
{
float l9_395;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_396=clamp(l9_393.w*2.0,0.0,1.0);
}
#else
{
float l9_397;
...
{
l9_397=clamp(dot(l9_393.xyz,vec3(l9_393.w)),0.0,1.0);
}
#else
{
float l9_398;
...
#if (sc_BlendMode_Multiply)
{
l9_399=(1.0-dot(l9_393.xyz,vec3(0.33333001)))*l9_393.w;
}
#else
{
float l9_400;
...
{
l9_400=(1.0-clamp(dot(l9_393.xyz,vec3(1.0)),0.0,1.0))*l9_393.w;
}
#else
{
float l9_401;
#if (sc_BlendMode_ColoredGlass)
{
l9_401=clamp(dot(l9_393.xyz,vec3(1.0)),0.0,1.0)*l9_393.w;
}
#else
{
float l9_402;
#if (sc_BlendMode_Add)
{
l9_402=clamp(dot(l9_393.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_403;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_403=clamp(dot(l9_393.xyz,vec3(1.0)),0.0,1.0)*l9_393.w;
}
#else
{
float l9_404;
...
{
l9_404=dot(l9_393.xyz,vec3(0.33333001))*l9_393.w;
}
#else
{
float l9_405;
#if (sc_BlendMode_Min)
{
l9_405=1.0-clamp(dot(l9_393.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_406;
#if (sc_BlendMode_Max)
{
l9_406=clamp(dot(l9_393.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_406=1.0;
...
#endif
l9_394=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_393.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_395);
}
#else
{
vec4 l9_407;
...
{
vec3 l9_409=sc_GetFramebufferColor().xyz;
vec3 l9_410=mix(l9_409,definedBlend(l9_409,l9_393.xyz).xyz,vec3(l9_393.w));
vec4 l9_411=vec4(l9_410.x,l9_410.y,l9_410.z,vec4(0.0).w);
l9_411.w=1.0;
l9_408=l9_411;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_413=l9_393.w;
l9_412=vec4(mix(vec3(1.0),l9_393.xyz,vec3(l9_413)),l9_413);
}
#else
{
vec4 l9_414;
...
{
float l9_415=l9_393.w;
float l9_416;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_416=clamp(l9_415,0.0,1.0);
}
#else
{
l9_416=l9_415;
...
#endif
l9_414=vec4(l9_393.xyz*l9_416,l9_416);
}
#else
{
l9_414=l9_393;
...
{
l9_419=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_419=vec4(0.0);
...
vec4 l9_421=outputMotionVectorsIfNeeded(varPos,max(l9_420,vec4(0.0)));
vec4 l9_422=clamp(l9_421,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_423=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_423-0.0039215689)),min(1.0,l9_423+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_424=sc_ScreenCoordsGlobalToView(l9_2);
...
#endif
int l9_425=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_424).xy);
float l9_426=packValue(l9_425);
int l9_433=int(l9_422.w*255.0);
float l9_434=packValue(l9_433);
sc_writeFragData0Internal(vec4(packValue(l9_425),packValue(l9_425),packValue(l9_425),packValue(l9_425)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_426,packValue(l9_425),packValue(l9_425),packValue(l9_425)));
sc_writeFragData2(vec4(l9_434,packValue(l9_433),packValue(l9_433),packValue(l9_433)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_437=sc_ScreenCoordsGlobalToView(l9_2);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_437).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_442==0)
{
l9_445=texture2D(sc_OITAlpha0,l9_437);
l9_444=texture2D(sc_OITDepthLow0,l9_437);
l9_443=texture2D(sc_OITDepthHigh0,l9_437);
}
else
{
l9_445=vec4(0.0);
...
if (l9_442==1)
{
l9_448=texture2D(sc_OITAlpha1,l9_437);
l9_447=texture2D(sc_OITDepthLow1,l9_437);
l9_446=texture2D(sc_OITDepthHigh1,l9_437);
}
else
{
l9_448=l9_445;
...
if (any(notEqual(l9_446,vec4(0.0)))||any(notEqual(l9_447,vec4(0.0))))
{
int l9_449[8]=l9_438;
unpackValues(l9_446.w,l9_442,l9_449);
unpackValues(l9_446.z,l9_442,l9_449);
unpackValues(l9_446.y,l9_442,l9_449);
unpackValues(l9_446.x,l9_442,l9_449);
unpackValues(l9_447.w,l9_442,l9_449);
unpackValues(l9_447.z,l9_442,l9_449);
unpackValues(l9_447.y,l9_442,l9_449);
unpackValues(l9_447.x,l9_442,l9_449);
int l9_458[8]=l9_439;
unpackValues(l9_448.w,l9_442,l9_458);
unpackValues(l9_448.z,l9_442,l9_458);
unpackValues(l9_448.y,l9_442,l9_458);
unpackValues(l9_448.x,l9_442,l9_458);
}
l9_442++;
continue;
}
...
vec4 l9_463=texture2D(sc_OITFilteredDepthBoundsTexture,l9_437);
vec2 l9_464=l9_463.xy;
int l9_465;
#if (sc_SkinBonesCount>0)
{
l9_465=encodeDepth(((1.0-l9_463.x)*1000.0)+getDepthOrderingEpsilon(),l9_464);
}
#else
{
l9_465=0;
...
#endif
int l9_466=encodeDepth(viewSpaceDepth(),l9_464);
vec4 l9_467;
l9_467=l9_422*l9_422.w;
vec4 l9_468;
int l9_469=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_469<8)
{
int l9_470=l9_438[l9_469];
int l9_471=l9_466-l9_465;
bool l9_472=l9_470<l9_471;
bool l9_473;
if (l9_472)
{
l9_473=l9_438[l9_469]>0;
}
else
{
l9_473=l9_472;
...
if (l9_473)
{
vec3 l9_474=l9_467.xyz*(1.0-(float(l9_439[l9_469])/255.0));
l9_468=vec4(l9_474.x,l9_474.y,l9_474.z,l9_467.w);
}
else
{
l9_468=l9_467;
...
sc_writeFragData0Internal(l9_467,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_421,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
