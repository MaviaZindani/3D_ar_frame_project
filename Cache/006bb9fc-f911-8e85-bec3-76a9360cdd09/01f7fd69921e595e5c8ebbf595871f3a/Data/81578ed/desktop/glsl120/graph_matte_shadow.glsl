...
l9_8=mix(varPackedTex.xy,l9_9,vec2(l9_10));
}
#else
{
vec2 l9_11;
...
#endif
l9_11=mix(varPackedTex.xy,l9_12,vec2(l9_15-0.001));
}
#else
{
...
#endif
vec3 l9_66=mix(l9_64.xyz,definedBlend(l9_64.xyz,l9_42.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_68=vec4(mix(vec3(1.0),l9_42.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_69;
...
{
l9_70=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_77-0.0039215689)),min(1.0,l9_77+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_79),packValue(l9_79),packValue(l9_79),packValue(l9_79)),sc_UniformConstants.x,sc_ShaderCacheConstant);
