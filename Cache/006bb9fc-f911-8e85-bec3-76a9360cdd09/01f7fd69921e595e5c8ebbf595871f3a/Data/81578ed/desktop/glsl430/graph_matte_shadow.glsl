...
l9_11=mix(l9_2,l9_12,vec2(l9_13));
}
#else
{
vec2 l9_14;
...
#endif
l9_14=mix(l9_2,l9_15,vec2(l9_18-0.001));
}
#else
{
l9_14=l9_2;
...
#else
{
bool l9_44=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_45=l9_9.x;
sc_SoftwareWrapEarly(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_46=l9_45;
float l9_47=l9_9.y;
sc_SoftwareWrapEarly(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_48=l9_47;
vec2 l9_49;
float l9_50;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_51=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_51=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_52=l9_46;
float l9_53=1.0;
sc_ClampUV(l9_52,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_51,l9_53);
float l9_54=l9_52;
float l9_55=l9_53;
bool l9_56;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_57=l9_48;
float l9_58=l9_55;
sc_ClampUV(l9_57,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_56,l9_58);
l9_50=l9_58;
...
#endif
vec2 l9_59=sc_TransformUV(l9_49,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_60=l9_59.x;
float l9_61=l9_50;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_44,l9_61);
float l9_62=l9_59.y;
float l9_63=l9_61;
sc_SoftwareWrapLate(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_44,l9_63);
float l9_64=l9_63;
vec3 l9_65=sc_SamplingCoordsViewToGlobal(vec2(l9_60,l9_62),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_66=texture(opacityTex,l9_65.xy,0.0);
vec4 l9_67;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_67=mix(opacityTexBorderColor,l9_66,vec4(l9_64));
}
#else
{
l9_67=l9_66;
...
#endif
l9_6=mix(Port_Input0_N006,l9_8,vec3(l9_19.x));
}
#else
{
vec3 l9_68;
Node0_Shadow_Sample(l9_68,l9_5);
l9_6=l9_68;
}
#endif
vec4 l9_69=vec4(l9_6.x,l9_6.y,l9_6.z,vec4(0.0).w);
l9_69.w=Port_Value2_N001;
...
{
l9_74=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_75;
...
{
l9_75=clamp(dot(l9_69.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_76;
...
{
l9_77=(1.0-dot(l9_69.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_78;
...
{
l9_78=(1.0-clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_79;
...
{
l9_79=clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_80;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_81=clamp(dot(l9_69.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_82;
...
{
l9_82=dot(l9_69.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_83;
...
#endif
vec3 l9_96=mix(l9_94.xyz,definedBlend(l9_94.xyz,l9_69.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_98=vec4(mix(vec3(1.0),l9_69.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_99;
...
{
l9_100=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_100=Port_Value2_N001;
}
#endif
l9_99=vec4(l9_69.xyz*l9_100,l9_100);
}
#else
{
l9_99=l9_69;
...
{
l9_103=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_103=vec4(0.0);
...
vec4 l9_105=outputMotionVectorsIfNeeded(varPos,max(l9_104,vec4(0.0)));
...
#endif
int l9_109=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_108).xy);
...
if (l9_126==0)
{
l9_129=texture(sc_OITAlpha0,l9_121);
l9_128=texture(sc_OITDepthLow0,l9_121);
l9_127=texture(sc_OITDepthHigh0,l9_121);
}
else
{
l9_129=vec4(0.0);
...
if (l9_126==1)
{
l9_132=texture(sc_OITAlpha1,l9_121);
l9_131=texture(sc_OITDepthLow1,l9_121);
l9_130=texture(sc_OITDepthHigh1,l9_121);
}
else
{
l9_132=l9_129;
...
vec4 l9_147=texture(sc_OITFilteredDepthBoundsTexture,l9_121);
